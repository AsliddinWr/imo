...
export default function AdminTestFormModal({
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-slate-950/55 px-4 py-8 backdrop-blur-sm">
      <div className="max-h-[92vh] w-full max-w-3xl overflow-y-auto rounded-[28px] border border-[#DDE4F3] bg-white shadow-[0_28px_90px_rgba(19,16,43,0.22)]">
        <div className="sticky top-0 z-10 flex items-center justify-between border-b border-[#ECE9FF] bg-white/95 px-6 py-5 backdrop-blur">
          <div>
            <p className="text-[10px] font-black uppercase tracking-[0.26em] text-[#071A52]">
          ...
          <button
            type="button"
            onClick={onClose}
            className="grid h-11 w-11 place-items-center rounded-2xl border border-[#DDE4F3] text-[#6B6880] transition hover:border-[#E24B4A] hover:text-[#E24B4A]"
            aria-label="Close"
          >
            <X size={20} />
          </button>
        ...
        <div className="space-y-6 p-6">
          <div className="rounded-3xl border border-[#DDE4F3] bg-[#F8FAFE] p-4">
              ...
              <button
                ...
                className={`rounded-2xl border p-4 text-left transition ${
                  form.test_mode === "builder"
                    ? "border-[#071A52] bg-white shadow-[0_8px_24px_rgba(7,26,82,.14)]"
                    : "border-[#DDE4F3] bg-white/60 hover:border-[#071A52]"
                }`}
              >
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <label className="block">
              ...
              <input
                ...
                className="w-full rounded-2xl border border-[#DDE4F3] bg-white px-4 py-3 text-sm font-bold outline-none transition focus:border-[#071A52]"
              />
            </label>
          ...
          {form.test_mode === "html" && (
            <div className="rounded-3xl border border-dashed border-[#B8B0FF] bg-[#F8FAFE] p-5">
              <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                ...
                <label className="inline-flex cursor-pointer items-center justify-center rounded-2xl bg-[#071A52] px-5 py-3 text-sm font-black text-white shadow-[0_8px_24px_rgba(7,26,82,.22)] transition hover:-translate-y-0.5 hover:bg-[#0D2A6B]">
                  Choose HTML
                  <input
                    type="file"
              ...
              {form.html_file_name && (
                <div className="mt-4 rounded-2xl border border-[#DDE4F3] bg-white p-4">
          ...
          <label className="block">
            ...
            <textarea
              ...
              className="min-h-[130px] w-full resize-none rounded-2xl border border-[#DDE4F3] bg-white px-4 py-3 text-sm leading-7 outline-none transition focus:border-[#071A52]"
            />
          </label>
        </div>
        ...
        <div className="sticky bottom-0 flex flex-col justify-end gap-3 border-t border-[#ECE9FF] bg-white/95 px-6 py-5 backdrop-blur md:flex-row">
          <button
            type="button"
            onClick={onClose}
            className="rounded-xl border border-[#DDE4F3] bg-white px-5 py-3 text-sm font-bold text-[#6B6880] transition hover:border-[#071A52] hover:text-[#071A52]"
          >
            Cancel
          </button>
          <button
            ...
            disabled={saving}
            onClick={onSave}
            className="rounded-xl bg-[#071A52] px-5 py-3 text-sm font-bold text-white shadow-[0_8px_24px_rgba(7,26,82,.22)] transition hover:-translate-y-0.5 hover:bg-[#0D2A6B] disabled:cursor-not-allowed disabled:opacity-60"
          >
